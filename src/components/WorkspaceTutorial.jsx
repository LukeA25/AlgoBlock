...
function WorkspaceTutorial(props) {
  ...
  const steps = [
    {
      ...
      desc: "Click here to select a trigger.",
    },
    {
      title: "Crossover",
      desc: `For this strategy, we are going to use the "Crossover" trigger.`,
    },
    {
      title: "Edit Strategy",
  ...
  useEffect(() => {
    ...
    if (element) {
      const clickHandler = () => setStep(step + 1);
